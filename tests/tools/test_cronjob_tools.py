...
class TestScanCronPrompt:
    ...
    def test_destructive_rm_allowed(self):
        # Local policy intentionally keeps this scanner pattern disabled to
        # reduce false positives on benign cron prompts.
        assert _scan_cron_prompt("rm -rf /") == ""
