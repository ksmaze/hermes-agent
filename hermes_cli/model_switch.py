...
def list_authenticated_providers(
    ...
    if custom_providers and isinstance(custom_providers, list):
        ...
        for entry in custom_providers:
            ...
            group_key = (api_url, credential_identity, entry_api_mode)
            ...
            for model_name in models_list:
                if model_name and model_name not in groups[group_key]["models"]:
                    groups[group_key]["models"].append(model_name)
        ...
        for grp_key, grp in groups.items():
            ...
            results.append({
                ...
                "is_current": (
                    ...
                    or grp["name"].strip().lower() == current_provider_norm
                    or (
