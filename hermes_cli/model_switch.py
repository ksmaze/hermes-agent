...
def list_authenticated_providers(
    ...
    *,
    ...
    def _entry_api_mode(entry: dict, api_url: str = "") -> str | None:
        ...
        if transport:
            return transport
        # Unspecified custom-provider wire mode remains unknown here. Let the
        # live fetch/runtime resolver infer it instead of pinning picker rows to
        # chat_completions; fork tests depend on keyless/local endpoints probing
        # with api_mode=None, while explicit api_mode/transport still separates
        # cache/group identity.
        return None
            ...
            if group_key not in groups:
                ...
                if (
                    ...
                    slug = (
                        ...
                        else custom_provider_slug(display_name, provider_key)
                    )
                else:
