...
class AIAgent:
    ...
    def __init__(
        ...
        try:
            ...
            _agent_cfg = {}
        # Keep the parsed config available for runtime lookups that need to
        # inspect custom provider metadata or explicit overrides.
        ...
        # needed later by the startup feasibility check.
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if _profile:
            ...
            if self.provider == "custom" and self._supports_reasoning_extra_body():
                extra_body = kwargs.setdefault("extra_body", {})
                if "reasoning" not in extra_body:
                    effort = "medium"
                    if self.reasoning_config and isinstance(self.reasoning_config, dict):
                        effort = str(self.reasoning_config.get("effort", "medium") or "medium").strip().lower() or "medium"
